...
import { streamFromArray, streamToString, chainStreams, renderToInitialStream, continueFromInitialStream } from "./stream-utils/node-web-streams-helper";
...
export async function renderToHTMLImpl(req, res, pathname, query, renderOpts, extra) {
    ...
    const { err , dev =false , ampPath ="" , pageConfig ={} , buildManifest , reactLoadableManifest , ErrorDebug , getStaticProps , getStaticPaths , getServerSideProps , isDataReq , params , previewProps , basePath , images , runtime: globalRuntime  } = renderOpts;
    const { App  } = extra;
    ...
    (_getTracer_getRootSpanAttributes = getTracer().getRootSpanAttributes()) == null ? void 0 : _getTracer_getRootSpanAttributes.set("next.route", renderOpts.pathname);
