...
export function warnOptionHasBeenMovedOutOfExperimental(config, oldKey, newKey, configFileName, silent = false) {
...
export default async function loadConfig(phase, dir, customConfig, rawConfig, silent) {
