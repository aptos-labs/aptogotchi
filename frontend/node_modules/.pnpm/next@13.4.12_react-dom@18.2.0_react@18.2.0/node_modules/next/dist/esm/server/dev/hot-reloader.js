                ...
                await Promise.all(Object.keys(entries).map(async (entryKey)=>{
                    ...
                    if (isChildEntry) {
                        if (entryData.absoluteEntryFilePath) {
                            const pageExists = !dispose && await fileExists(entryData.absoluteEntryFilePath);
                            if (!pageExists) {
                                delete entries[entryKey];
                                return;
                            }
                    ...
                    runDependingOnPageType({
                        ...
                        onServer: ()=>{
                            ...
                            } else if (!isAPIRoute(page) && !isMiddlewareFile(page) && !isInternalComponent(relativeRequest)) {
                                ...
                                if (chunk.id === key) {
                                    ...
                                    modsIterable.forEach((mod)=>{
                                        ...
                                        pageExtensionRegex.test(mod.resource)) {
                                            ...
                                            var _mod_buildInfo1, _mod_buildInfo_rsc1;
