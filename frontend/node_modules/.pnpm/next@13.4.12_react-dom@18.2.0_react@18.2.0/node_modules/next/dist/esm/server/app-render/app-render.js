        ...
        const bodyResult = getTracer().wrap(AppRenderSpan.getBodyResult, {
            ...
            const getServerInsertedHTML = (serverCapturedErrors)=>{
                ...
                const flushed = renderToString({
                    ...
                    element: /*#__PURE__*/ React.createElement(React.Fragment, null, Array.from(serverInsertedHTMLCallbacks).map((callback, index)=>/*#__PURE__*/ React.createElement(React.Fragment, {
            ...
            try {
                ...
                const serverErrorComponentsRenderOpts = {
                    ...
                    rscChunks: [],
                    transformStream: is404 ? new TransformStream() : cloneTransformStream(serverComponentsRenderOpts.transformStream)
                };
                ...
                const ErrorPage = createServerComponentRenderer(async ()=>{
                    ...
                    const initialTree = createFlightRouterStateFromLoaderTree(notFoundLoaderTree, getDynamicParamFromSegment, query);
                    const GlobalNotFound = NotFound || DefaultNotFound;
                    const ErrorLayout = RootLayout || ErrorHtml;
                    const notFoundElement = /*#__PURE__*/ React.createElement(ErrorLayout, {
                        params: {}
                    }, rootStyles, notFoundStyles, /*#__PURE__*/ React.createElement(GlobalNotFound, null));
                    ...
                    return /*#__PURE__*/ React.createElement(AppRouter, {
                        ...
                        initialHead: head,
                        globalErrorComponent: GlobalError
                    }, is404 ? notFoundElement : /*#__PURE__*/ React.createElement(ErrorHtml, {
                        head: head
                    }));
                ...
                try {
                    ...
                    if (process.env.NODE_ENV !== "production" && isNotFoundError(finalErr)) {
